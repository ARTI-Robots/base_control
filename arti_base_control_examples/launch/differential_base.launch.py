...
def generate_launch_description():
    ...
    urdf_file = PathJoinSubstitution([pkg_share, 'urdf', 'differential_base.urdf.xacro'])
    config_file = PathJoinSubstitution([pkg_share, 'config', 'differential_base.yaml'])
    ...
    base_control_node = Node(
        ...
        executable='arti_base_control_node',
        name='base_control',
        output='screen',
        respawn=respawn,
        parameters=[
            config_file,
            {
                ...
                # Vehicle parameters (same structure as in the Ackermann launch)
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('max_steering_angle', default_value='1.5708'),
